    ...
    public static void merge(int [] numbers, int i, int j, int k) {
        ...
        while (leftPos <= j && rightPos <= k) {
            ...
            if (numbers[leftPos] < numbers[rightPos]) {
                comparisons++; //must be in both places
...
```
###Challenge
The only issue I ran into was getting the comparisons variable to be reachable by everything. (I had to make it global)
