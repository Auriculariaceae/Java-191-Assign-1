...
if statement and then changing that condition when a non single character palindrome was entered. Making a working while loop to keep asking for a word resulted in a lot of trial and error.
